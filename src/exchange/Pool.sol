...
contract Pool is MockERC20 {
    ...
    /*//////////////////////////////////////////////////////////////
                            STATE VARIABLES
    //////////////////////////////////////////////////////////////*/
    MockERC20 private immutable i_wethToken;
    MockERC20 private immutable i_poolToken;
    ...
    ) MockERC20(liquidityTokenName, liquidityTokenSymbol, 18) {
        i_wethToken = MockERC20(wethToken);
        i_poolToken = MockERC20(poolToken);
    }
        ...
        revertIfZero(minPoolTokensToWithdraw)
    {
        ...
        i_wethToken.transfer(msg.sender, wethToWithdraw);
        i_poolToken.transfer(msg.sender, poolTokensToWithdraw);
    }
    ...
    function _isUnknown(MockERC20 token) private view returns (bool) {
