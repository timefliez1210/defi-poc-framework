...
contract AssetToken is MockERC20 {
    ...
    /*//////////////////////////////////////////////////////////////
                            STATE VARIABLES
    //////////////////////////////////////////////////////////////*/
    MockERC20 private immutable i_underlying;
    ...
    function mint(address to, uint256 amount) public override onlyThunderLoan {
        mint(to, amount);
    }

    function burn(address account, uint256 amount) public override onlyThunderLoan {
        burn(account, amount);
    }

    function transferUnderlyingTo(address to, uint256 amount) external onlyThunderLoan {
        i_underlying.transfer(to, amount);
    }
    ...
    function getUnderlying() external view returns (MockERC20) {
        return i_underlying;
    }
}